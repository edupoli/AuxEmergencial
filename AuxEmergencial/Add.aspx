<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="AuxEmergencial.Add" %>
...
<div class="form-row">
  <div class="form-group col-md-2">
    <label for="CEP">CEP</label>
      <asp:TextBox runat="server" CssClass="form-control" ID="cep" placeholder="CEP" OnTextChanged="cep_TextChanged" AutoPostBack="true"/>
...
<div class="form-row">
 ...
 <div class="form-row">
  ...
  <div class="form-row">
      <div class="form-group col-md-12">
          <label></label>
        <asp:Button Text="Cadastrar" runat="server" ID="btnCadastrar" CssClass="btn btn-primary" OnClick="btnCadastrar_Click" />
